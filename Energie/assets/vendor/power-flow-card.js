...
class PowerFlowCard extends LitElement {
  ...
  constructor() {
    ...
    this.svgPaths = {
      ...
      wallbox: "data:image/svg+xml;base64,",
  ...
  async loadSVG(path, containerEl, lineType, isBackground) {
    try {
      ...
      if (isBackground) {
        ...
        // Die frühere Netz-Eingangsleitung steckt zusätzlich fest im
        // Hintergrund-SVG. Sie wird jetzt ebenfalls entfernt, weil ihre
        // Geometrie als neue dynamische Wallboxleitung verwendet wird.
        const oldGridInputLine = doc.querySelector("#powerline-grid");
        if (oldGridInputLine) {
          oldGridInputLine.remove();
        }
  ...
  static get styles() {
    return css`
      ...
      /* Nur die beiden ersetzten festen Leitungen ausblenden. */
      #svg-container-bg #powerline-house,
      #svg-container-bg #powerline-grid {
