                                ...
                                [
                                    ...
                                    'edit'    => [
                                        ...
                                        'options' => [
                                            ...
                                            ['caption' => 'Herd / Backofen', 'value' => 'fire-burner'],
                                            ['caption' => 'Waschmaschine', 'value' => 'shirt'],
                                            ['caption' => 'Trockner / Luft', 'value' => 'wind'],
                                            ['caption' => 'Geschirrspüler', 'value' => 'sink'],
                                            ['caption' => 'Boiler / Warmwasser', 'value' => 'faucet-drip'],
                                            ['caption' => 'Wasser', 'value' => 'droplet'],
                                            ['caption' => 'Kühlschrank / Kälte', 'value' => 'snowflake'],
                                            ['caption' => 'Licht', 'value' => 'lightbulb'],
                                            ['caption' => 'Lüfter', 'value' => 'fan'],
                                            ['caption' => 'Pool', 'value' => 'person-swimming'],
                                            ['caption' => 'Dusche', 'value' => 'shower'],
                                            ['caption' => 'Heizung', 'value' => 'temperature-high'],
                                            ['caption' => 'Wärmepumpe', 'value' => 'temperature-arrow-up'],
                                            ['caption' => 'Fernseher', 'value' => 'tv'],
                                            ['caption' => 'Computer', 'value' => 'desktop'],
                                            ['caption' => 'Laptop', 'value' => 'laptop'],
                                            ['caption' => 'Server', 'value' => 'server'],
                                            ['caption' => 'Drucker', 'value' => 'print'],
                                            ['caption' => 'Kaffeemaschine', 'value' => 'mug-hot'],
                                            ['caption' => 'Wallbox / Ladestation', 'value' => 'charging-station'],
                                            ['caption' => 'Auto', 'value' => 'car'],
                                            ['caption' => 'Haus', 'value' => 'house'],
                                            ['caption' => 'Garage / Lager', 'value' => 'warehouse'],
                                            ['caption' => 'Tür', 'value' => 'door-open'],
                                            ['caption' => 'Bett', 'value' => 'bed'],
                                            ['caption' => 'Toilette', 'value' => 'toilet'],
                                            ['caption' => 'Staubsauger', 'value' => 'broom'],
                                            ['caption' => 'Kamera', 'value' => 'video'],
                                            ['caption' => 'WLAN', 'value' => 'wifi'],
                                            ['caption' => 'Musik', 'value' => 'music'],
                                            ['caption' => 'Spielkonsole', 'value' => 'gamepad'],
                                        ],
                                    ],
                                ],
                                [
...
<script>
    ...
    function ensureHaCompatibility() {
        ...
        customElements.define('ha-icon', class extends HTMLElement {
            ...
            render() {
                const iconName = normalizeFaIcon(this.icon);

                /*
                 * Keine Positionierung, keine feste Breite/Höhe und kein
                 * Transform am ha-icon selbst. Diese Werte kommen vollständig
                 * aus dem von Sunsynk erzeugten foreignObject.
                 */
                ...
                // Nur den Inhalt im vorhandenen Platzhalter zentrieren.
                ...
                icon.style.fontSize = 'var(--mdc-icon-size, 24px)';
    ...
    function normalizeConsumerIcon(icon) {
        ...
        const selected = allowed.has(normalized)
            ? normalized
            : 'plug';
